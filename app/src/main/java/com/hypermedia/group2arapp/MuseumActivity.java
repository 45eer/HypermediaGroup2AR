...
public class MuseumActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    private static final String TAG = MuseumActivity.class.getSimpleName();
    private static final String SCENE_URL = "https://us-east-2.sumerian.aws/5cd769937f67420990b237280705e074.scene/?arMode=true";
